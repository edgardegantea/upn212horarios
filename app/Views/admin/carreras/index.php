...
<div class="container mt-5">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-5">
        ...
        <a class="btn btn-primary" href="<?= site_url('admin/carreras/create'); ?>">Nuevo</a>    
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form class="display-none" method="post" action="<?= base_url('admin/carreras/'.$carrera['id']); ?>" id="carreraDeleteForm<?=$carrera['id']?>">
                            ...
                            <a href="javascript:void(0)" onclick="deleteCarrera('carreraDeleteForm<?=$carrera['id']; ?>')" class="btn btn-sm btn-danger" title="Eliminar registro">Eliminar</a>
                        </form>
